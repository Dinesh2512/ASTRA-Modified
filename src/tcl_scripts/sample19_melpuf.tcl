...
read_hdl ../benchmarks/baseline/sample19.v
elaborate
...
report_area > ../reports/sample19/sample19_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample19/sample19_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample19/sample19_power.rpt
exit
