...
read_hdl ../benchmarks/baseline/bench07.v
elaborate
...
report_area > ../reports/bench07/bench07_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench07/bench07_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench07/bench07_power.rpt
exit
