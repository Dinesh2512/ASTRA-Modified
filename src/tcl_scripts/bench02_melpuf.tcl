...
read_hdl ../benchmarks/baseline/bench02.v
elaborate
...
report_area > ../reports/bench02/bench02_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench02/bench02_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench02/bench02_power.rpt
exit
