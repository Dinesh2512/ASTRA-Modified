...
read_hdl ../benchmarks/baseline/dbench18.v
elaborate
...
report_area > ../reports/dbench18/dbench18_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench18/dbench18_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench18/dbench18_power.rpt
exit
