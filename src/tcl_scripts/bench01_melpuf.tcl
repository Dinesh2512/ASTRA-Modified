...
read_hdl ../benchmarks/baseline/bench01.v
elaborate
...
report_area > ../reports/bench01/bench01_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench01/bench01_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench01/bench01_power.rpt
exit
