...
read_hdl ../benchmarks/baseline/dbench49.v
elaborate
...
report_area > ../reports/dbench49/dbench49_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench49/dbench49_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench49/dbench49_power.rpt
exit
