...
read_hdl ../benchmarks/baseline/dbench09.v
elaborate
...
report_area > ../reports/dbench09/dbench09_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench09/dbench09_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench09/dbench09_power.rpt
exit
