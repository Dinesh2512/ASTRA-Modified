...
read_hdl ../benchmarks/baseline/dbench45.v
elaborate
...
report_area > ../reports/dbench45/dbench45_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench45/dbench45_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench45/dbench45_power.rpt
exit
