...
read_hdl ../benchmarks/baseline/bench23.v
elaborate
...
report_area > ../reports/bench23/bench23_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench23/bench23_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench23/bench23_power.rpt
exit
