...
read_hdl ../benchmarks/baseline/dbench53.v
elaborate
...
report_area > ../reports/dbench53/dbench53_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench53/dbench53_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench53/dbench53_power.rpt
exit
