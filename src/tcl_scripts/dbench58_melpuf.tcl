...
read_hdl ../benchmarks/baseline/dbench58.v
elaborate
...
report_area > ../reports/dbench58/dbench58_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench58/dbench58_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench58/dbench58_power.rpt
exit
