...
read_hdl ../benchmarks/baseline/bench28.v
elaborate
...
report_area > ../reports/bench28/bench28_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench28/bench28_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench28/bench28_power.rpt
exit
