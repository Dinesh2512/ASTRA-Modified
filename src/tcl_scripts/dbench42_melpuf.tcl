...
read_hdl ../benchmarks/baseline/dbench42.v
elaborate
...
report_area > ../reports/dbench42/dbench42_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench42/dbench42_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench42/dbench42_power.rpt
exit
