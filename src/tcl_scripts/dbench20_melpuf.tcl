...
read_hdl ../benchmarks/baseline/dbench20.v
elaborate
...
report_area > ../reports/dbench20/dbench20_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench20/dbench20_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench20/dbench20_power.rpt
exit
