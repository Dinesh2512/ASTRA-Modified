...
read_hdl ../benchmarks/baseline/s349.v
elaborate
...
report_area > ../reports/s349/s349_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s349/s349_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s349/s349_power.rpt
exit
