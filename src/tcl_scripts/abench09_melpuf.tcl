...
read_hdl ../benchmarks/baseline/abench09.v
elaborate
...
report_area > ../reports/abench09/abench09_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/abench09/abench09_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/abench09/abench09_power.rpt
exit
