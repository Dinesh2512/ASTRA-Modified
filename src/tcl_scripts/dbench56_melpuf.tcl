...
read_hdl ../benchmarks/baseline/dbench56.v
elaborate
...
report_area > ../reports/dbench56/dbench56_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench56/dbench56_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench56/dbench56_power.rpt
exit
