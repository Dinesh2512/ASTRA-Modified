...
read_hdl ../benchmarks/baseline/dbench32.v
elaborate
...
report_area > ../reports/dbench32/dbench32_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench32/dbench32_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench32/dbench32_power.rpt
exit
