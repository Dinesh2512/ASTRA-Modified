...
read_hdl ../benchmarks/baseline/dbench15.v
elaborate
...
report_area > ../reports/dbench15/dbench15_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench15/dbench15_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench15/dbench15_power.rpt
exit
