...
read_hdl ../benchmarks/baseline/dbench19.v
elaborate
...
report_area > ../reports/dbench19/dbench19_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench19/dbench19_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench19/dbench19_power.rpt
exit
