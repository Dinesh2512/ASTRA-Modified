...
read_hdl ../benchmarks/baseline/bench11.v
elaborate
...
report_area > ../reports/bench11/bench11_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench11/bench11_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench11/bench11_power.rpt
exit
