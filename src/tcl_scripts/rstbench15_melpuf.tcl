...
read_hdl ../benchmarks/baseline/rstbench15.v
elaborate
...
report_area > ../reports/rstbench15/rstbench15_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/rstbench15/rstbench15_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/rstbench15/rstbench15_power.rpt
exit
