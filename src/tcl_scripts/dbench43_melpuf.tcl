...
read_hdl ../benchmarks/baseline/dbench43.v
elaborate
...
report_area > ../reports/dbench43/dbench43_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench43/dbench43_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench43/dbench43_power.rpt
exit
