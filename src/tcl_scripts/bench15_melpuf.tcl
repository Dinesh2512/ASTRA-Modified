...
read_hdl ../benchmarks/baseline/bench15.v
elaborate
...
report_area > ../reports/bench15/bench15_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench15/bench15_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench15/bench15_power.rpt
exit
