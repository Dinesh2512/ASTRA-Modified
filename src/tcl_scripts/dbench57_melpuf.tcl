...
read_hdl ../benchmarks/baseline/dbench57.v
elaborate
...
report_area > ../reports/dbench57/dbench57_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench57/dbench57_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench57/dbench57_power.rpt
exit
