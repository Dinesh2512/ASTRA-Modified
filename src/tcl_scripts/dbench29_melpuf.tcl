...
read_hdl ../benchmarks/baseline/dbench29.v
elaborate
...
report_area > ../reports/dbench29/dbench29_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench29/dbench29_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench29/dbench29_power.rpt
exit
