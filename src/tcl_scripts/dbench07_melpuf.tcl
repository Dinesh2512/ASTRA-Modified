...
read_hdl ../benchmarks/baseline/dbench07.v
elaborate
...
report_area > ../reports/dbench07/dbench07_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench07/dbench07_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench07/dbench07_power.rpt
exit
