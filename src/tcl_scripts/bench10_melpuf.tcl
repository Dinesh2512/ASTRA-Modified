...
read_hdl ../benchmarks/baseline/bench10.v
elaborate
...
report_area > ../reports/bench10/bench10_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench10/bench10_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench10/bench10_power.rpt
exit
