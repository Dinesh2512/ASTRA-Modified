...
read_hdl ../benchmarks/baseline/bench16.v
elaborate
...
report_area > ../reports/bench16/bench16_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench16/bench16_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench16/bench16_power.rpt
exit
