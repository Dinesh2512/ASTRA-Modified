...
read_hdl ../benchmarks/baseline/sample15.v
elaborate
...
report_area > ../reports/sample15/sample15_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample15/sample15_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample15/sample15_power.rpt
exit
