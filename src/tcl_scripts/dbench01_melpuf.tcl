...
read_hdl ../benchmarks/baseline/dbench01.v
elaborate
...
report_area > ../reports/dbench01/dbench01_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench01/dbench01_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench01/dbench01_power.rpt
exit
