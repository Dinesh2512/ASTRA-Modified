...
read_hdl ../benchmarks/baseline/dbench64.v
elaborate
...
report_area > ../reports/dbench64/dbench64_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench64/dbench64_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench64/dbench64_power.rpt
exit
