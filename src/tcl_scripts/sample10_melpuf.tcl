...
read_hdl ../benchmarks/baseline/sample10.v
elaborate
...
report_area > ../reports/sample10/sample10_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample10/sample10_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample10/sample10_power.rpt
exit
