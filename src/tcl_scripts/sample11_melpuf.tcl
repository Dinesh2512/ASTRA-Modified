...
read_hdl ../benchmarks/baseline/sample11.v
elaborate
...
report_area > ../reports/sample11/sample11_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample11/sample11_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample11/sample11_power.rpt
exit
