...
read_hdl ../benchmarks/baseline/dbench11.v
elaborate
...
report_area > ../reports/dbench11/dbench11_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench11/dbench11_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench11/dbench11_power.rpt
exit
