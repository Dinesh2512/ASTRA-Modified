...
read_hdl ../benchmarks/baseline/dbench03.v
elaborate
...
report_area > ../reports/dbench03/dbench03_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench03/dbench03_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench03/dbench03_power.rpt
exit
