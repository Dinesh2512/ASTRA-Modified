...
read_hdl ../benchmarks/baseline/des3.v
elaborate
...
report_area > ../reports/des3/des3_area_1024.rpt
remove_cdn_loop_breaker
report_timing > ../reports/des3/des3_timing_1024.rpt
remove_cdn_loop_breaker
report_power > ../reports/des3/des3_power_1024.rpt
exit
