...
read_hdl ../benchmarks/baseline/dbench52.v
elaborate
...
report_area > ../reports/dbench52/dbench52_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench52/dbench52_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench52/dbench52_power.rpt
exit
