...
read_hdl ../benchmarks/baseline/dbench63.v
elaborate
...
report_area > ../reports/dbench63/dbench63_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench63/dbench63_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench63/dbench63_power.rpt
exit
