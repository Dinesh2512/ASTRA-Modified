...
read_hdl ../benchmarks/baseline/rstbench9.v
elaborate
...
report_area > ../reports/rstbench9/rstbench9_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/rstbench9/rstbench9_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/rstbench9/rstbench9_power.rpt
exit
