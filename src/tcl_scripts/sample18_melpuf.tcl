...
read_hdl ../benchmarks/baseline/sample18.v
elaborate
...
report_area > ../reports/sample18/sample18_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample18/sample18_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample18/sample18_power.rpt
exit
