...
read_hdl ../benchmarks/baseline/bench17.v
elaborate
...
report_area > ../reports/bench17/bench17_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench17/bench17_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench17/bench17_power.rpt
exit
