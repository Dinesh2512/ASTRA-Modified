...
read_hdl ../benchmarks/baseline/sample13.v
elaborate
...
report_area > ../reports/sample13/sample13_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample13/sample13_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample13/sample13_power.rpt
exit
