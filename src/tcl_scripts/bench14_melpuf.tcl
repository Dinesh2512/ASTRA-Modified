...
read_hdl ../benchmarks/baseline/bench14.v
elaborate
...
report_area > ../reports/bench14/bench14_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench14/bench14_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench14/bench14_power.rpt
exit
