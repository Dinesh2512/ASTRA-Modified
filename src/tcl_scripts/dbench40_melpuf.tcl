...
read_hdl ../benchmarks/baseline/dbench40.v
elaborate
...
report_area > ../reports/dbench40/dbench40_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench40/dbench40_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench40/dbench40_power.rpt
exit
