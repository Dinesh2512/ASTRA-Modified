...
read_hdl ../benchmarks/baseline/dbench05.v
elaborate
...
report_area > ../reports/dbench05/dbench05_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench05/dbench05_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench05/dbench05_power.rpt
exit
