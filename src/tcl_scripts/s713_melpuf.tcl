...
read_hdl ../benchmarks/baseline/s713.v
elaborate
...
report_area > ../reports/s713/s713_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s713/s713_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s713/s713_power.rpt
exit
