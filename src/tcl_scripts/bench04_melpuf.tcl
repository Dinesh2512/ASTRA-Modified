...
read_hdl ../benchmarks/baseline/bench04.v
elaborate
...
report_area > ../reports/bench04/bench04_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench04/bench04_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench04/bench04_power.rpt
exit
