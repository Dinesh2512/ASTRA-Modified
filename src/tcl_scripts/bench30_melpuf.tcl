...
read_hdl ../benchmarks/baseline/bench30.v
elaborate
...
report_area > ../reports/bench30/bench30_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench30/bench30_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench30/bench30_power.rpt
exit
