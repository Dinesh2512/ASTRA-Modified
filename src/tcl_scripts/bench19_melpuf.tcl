...
read_hdl ../benchmarks/baseline/bench19.v
elaborate
...
report_area > ../reports/bench19/bench19_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench19/bench19_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench19/bench19_power.rpt
exit
