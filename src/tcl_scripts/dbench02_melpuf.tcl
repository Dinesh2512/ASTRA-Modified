...
read_hdl ../benchmarks/baseline/dbench02.v
elaborate
...
report_area > ../reports/dbench02/dbench02_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench02/dbench02_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench02/dbench02_power.rpt
exit
