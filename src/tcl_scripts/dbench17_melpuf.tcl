...
read_hdl ../benchmarks/baseline/dbench17.v
elaborate
...
report_area > ../reports/dbench17/dbench17_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench17/dbench17_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench17/dbench17_power.rpt
exit
