...
read_hdl ../benchmarks/baseline/s386.v
elaborate
...
report_area > ../reports/s386/s386_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s386/s386_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s386/s386_power.rpt
exit
