...
read_hdl ../benchmarks/baseline/bench06.v
elaborate
...
report_area > ../reports/bench06/bench06_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench06/bench06_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench06/bench06_power.rpt
exit
