...
read_hdl ../benchmarks/baseline/dbench47.v
elaborate
...
report_area > ../reports/dbench47/dbench47_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench47/dbench47_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench47/dbench47_power.rpt
exit
