...
read_hdl ../benchmarks/baseline/bench22.v
elaborate
...
report_area > ../reports/bench22/bench22_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench22/bench22_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench22/bench22_power.rpt
exit
