...
read_hdl ../benchmarks/baseline/dbench24.v
elaborate
...
report_area > ../reports/dbench24/dbench24_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench24/dbench24_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench24/dbench24_power.rpt
exit
