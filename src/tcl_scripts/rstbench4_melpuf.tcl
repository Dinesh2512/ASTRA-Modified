...
read_hdl ../benchmarks/baseline/rstbench4.v
elaborate
...
report_area > ../reports/rstbench4/rstbench4_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/rstbench4/rstbench4_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/rstbench4/rstbench4_power.rpt
exit
