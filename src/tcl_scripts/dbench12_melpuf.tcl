...
read_hdl ../benchmarks/baseline/dbench12.v
elaborate
...
report_area > ../reports/dbench12/dbench12_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench12/dbench12_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench12/dbench12_power.rpt
exit
