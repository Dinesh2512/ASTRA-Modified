...
read_hdl ../benchmarks/baseline/bench13.v
elaborate
...
report_area > ../reports/bench13/bench13_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench13/bench13_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench13/bench13_power.rpt
exit
