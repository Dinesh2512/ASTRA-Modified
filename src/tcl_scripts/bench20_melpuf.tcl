...
read_hdl ../benchmarks/baseline/bench20.v
elaborate
...
report_area > ../reports/bench20/bench20_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench20/bench20_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench20/bench20_power.rpt
exit
