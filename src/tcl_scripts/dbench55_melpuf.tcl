...
read_hdl ../benchmarks/baseline/dbench55.v
elaborate
...
report_area > ../reports/dbench55/dbench55_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench55/dbench55_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench55/dbench55_power.rpt
exit
