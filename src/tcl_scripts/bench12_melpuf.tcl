...
read_hdl ../benchmarks/baseline/bench12.v
elaborate
...
report_area > ../reports/bench12/bench12_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench12/bench12_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench12/bench12_power.rpt
exit
