...
read_hdl ../benchmarks/baseline/dbench34.v
elaborate
...
report_area > ../reports/dbench34/dbench34_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench34/dbench34_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench34/dbench34_power.rpt
exit
