...
read_hdl ../benchmarks/baseline/dbench23.v
elaborate
...
report_area > ../reports/dbench23/dbench23_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench23/dbench23_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench23/dbench23_power.rpt
exit
