...
read_hdl ../benchmarks/baseline/dbench14.v
elaborate
...
report_area > ../reports/dbench14/dbench14_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench14/dbench14_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench14/dbench14_power.rpt
exit
