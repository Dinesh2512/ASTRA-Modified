...
read_hdl ../benchmarks/baseline/s344.v
elaborate
...
report_area > ../reports/s344/s344_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s344/s344_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s344/s344_power.rpt
exit
