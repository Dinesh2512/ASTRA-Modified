...
read_hdl ../benchmarks/baseline/s838.v
elaborate
...
report_area > ../reports/s838/s838_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s838/s838_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s838/s838_power.rpt
exit
