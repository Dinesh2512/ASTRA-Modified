...
read_hdl ../benchmarks/baseline/dbench39.v
elaborate
...
report_area > ../reports/dbench39/dbench39_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench39/dbench39_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench39/dbench39_power.rpt
exit
