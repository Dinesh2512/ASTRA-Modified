...
read_hdl ../benchmarks/baseline/bench26.v
elaborate
...
report_area > ../reports/bench26/bench26_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench26/bench26_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench26/bench26_power.rpt
exit
