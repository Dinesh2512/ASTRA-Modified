...
read_hdl ../benchmarks/baseline/dbench46.v
elaborate
...
report_area > ../reports/dbench46/dbench46_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench46/dbench46_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench46/dbench46_power.rpt
exit
