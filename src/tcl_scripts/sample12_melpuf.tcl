...
read_hdl ../benchmarks/baseline/sample12.v
elaborate
...
report_area > ../reports/sample12/sample12_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample12/sample12_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample12/sample12_power.rpt
exit
