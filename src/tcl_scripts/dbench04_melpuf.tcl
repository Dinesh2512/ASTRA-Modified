...
read_hdl ../benchmarks/baseline/dbench04.v
elaborate
...
report_area > ../reports/dbench04/dbench04_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench04/dbench04_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench04/dbench04_power.rpt
exit
