...
read_hdl ../benchmarks/baseline/dbench51.v
elaborate
...
report_area > ../reports/dbench51/dbench51_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench51/dbench51_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench51/dbench51_power.rpt
exit
