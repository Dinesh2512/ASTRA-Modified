...
read_hdl ../benchmarks/baseline/bench27.v
elaborate
...
report_area > ../reports/bench27/bench27_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench27/bench27_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench27/bench27_power.rpt
exit
