...
read_hdl ../benchmarks/baseline/dbench27.v
elaborate
...
report_area > ../reports/dbench27/dbench27_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench27/dbench27_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench27/dbench27_power.rpt
exit
