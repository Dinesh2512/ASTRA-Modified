...
read_hdl ../benchmarks/baseline/dbench36.v
elaborate
...
report_area > ../reports/dbench36/dbench36_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench36/dbench36_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench36/dbench36_power.rpt
exit
