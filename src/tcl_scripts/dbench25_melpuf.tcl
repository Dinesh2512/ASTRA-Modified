...
read_hdl ../benchmarks/baseline/dbench25.v
elaborate
...
report_area > ../reports/dbench25/dbench25_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench25/dbench25_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench25/dbench25_power.rpt
exit
