...
read_hdl ../benchmarks/baseline/rstbench6.v
elaborate
...
report_area > ../reports/rstbench6/rstbench6_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/rstbench6/rstbench6_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/rstbench6/rstbench6_power.rpt
exit
