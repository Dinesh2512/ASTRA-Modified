...
read_hdl ../benchmarks/baseline/sample8.v
elaborate
...
report_area > ../reports/sample8/sample8_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample8/sample8_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample8/sample8_power.rpt
exit
