...
read_hdl ../benchmarks/baseline/dbench28.v
elaborate
...
report_area > ../reports/dbench28/dbench28_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench28/dbench28_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench28/dbench28_power.rpt
exit
