...
read_hdl ../benchmarks/baseline/dbench48.v
elaborate
...
report_area > ../reports/dbench48/dbench48_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench48/dbench48_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench48/dbench48_power.rpt
exit
