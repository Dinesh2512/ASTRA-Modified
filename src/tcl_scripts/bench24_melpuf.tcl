...
read_hdl ../benchmarks/baseline/bench24.v
elaborate
...
report_area > ../reports/bench24/bench24_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench24/bench24_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench24/bench24_power.rpt
exit
