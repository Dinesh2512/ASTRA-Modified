...
read_hdl ../benchmarks/baseline/bench29.v
elaborate
...
report_area > ../reports/bench29/bench29_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench29/bench29_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench29/bench29_power.rpt
exit
