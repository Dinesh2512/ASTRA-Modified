...
read_hdl ../benchmarks/baseline/sample9.v
elaborate
...
report_area > ../reports/sample9/sample9_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample9/sample9_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample9/sample9_power.rpt
exit
