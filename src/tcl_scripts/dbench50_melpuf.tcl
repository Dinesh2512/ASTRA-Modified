...
read_hdl ../benchmarks/baseline/dbench50.v
elaborate
...
report_area > ../reports/dbench50/dbench50_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench50/dbench50_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench50/dbench50_power.rpt
exit
