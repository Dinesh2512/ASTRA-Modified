...
read_hdl ../benchmarks/baseline/dbench59.v
elaborate
...
report_area > ../reports/dbench59/dbench59_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench59/dbench59_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench59/dbench59_power.rpt
exit
