...
read_hdl ../benchmarks/baseline/sample14.v
elaborate
...
report_area > ../reports/sample14/sample14_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample14/sample14_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample14/sample14_power.rpt
exit
