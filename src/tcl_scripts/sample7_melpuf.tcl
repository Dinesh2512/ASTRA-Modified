...
read_hdl ../benchmarks/baseline/sample7.v
elaborate
...
report_area > ../reports/sample7/sample7_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/sample7/sample7_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/sample7/sample7_power.rpt
exit
