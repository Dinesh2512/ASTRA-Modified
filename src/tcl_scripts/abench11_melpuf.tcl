...
read_hdl ../benchmarks/baseline/abench11.v
elaborate
...
report_area > ../reports/abench11/abench11_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/abench11/abench11_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/abench11/abench11_power.rpt
exit
