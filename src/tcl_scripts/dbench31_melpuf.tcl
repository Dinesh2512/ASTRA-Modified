...
read_hdl ../benchmarks/baseline/dbench31.v
elaborate
...
report_area > ../reports/dbench31/dbench31_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench31/dbench31_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench31/dbench31_power.rpt
exit
