...
read_hdl ../benchmarks/baseline/bench21.v
elaborate
...
report_area > ../reports/bench21/bench21_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench21/bench21_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench21/bench21_power.rpt
exit
