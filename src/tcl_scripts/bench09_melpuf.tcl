...
read_hdl ../benchmarks/baseline/bench09.v
elaborate
...
report_area > ../reports/bench09/bench09_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/bench09/bench09_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/bench09/bench09_power.rpt
exit
