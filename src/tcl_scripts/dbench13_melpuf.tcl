...
read_hdl ../benchmarks/baseline/dbench13.v
elaborate
...
report_area > ../reports/dbench13/dbench13_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/dbench13/dbench13_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/dbench13/dbench13_power.rpt
exit
