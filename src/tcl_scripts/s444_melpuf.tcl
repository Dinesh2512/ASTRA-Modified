...
read_hdl ../benchmarks/baseline/s444.v
elaborate
...
report_area > ../reports/s444/s444_area.rpt
remove_cdn_loop_breaker
report_timing > ../reports/s444/s444_timing.rpt
remove_cdn_loop_breaker
report_power > ../reports/s444/s444_power.rpt
exit
