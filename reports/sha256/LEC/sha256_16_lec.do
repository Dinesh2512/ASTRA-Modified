...
read design -golden original_flat_16.v
read design -revised revised_flat_16.v
set system mode setup 
add pin constraints 1 sel  -module sha256  -revised
add ignore outputs pufout* -module sha256  -revised
report primary outputs > "$module_name"_16.primary_outputs.rpt
set system mode lec > "$module_name"_16.system_mode_lec.rpt
add compared points -all -golden
compare
report verification -verbose > "$module_name"_16.verification.rpt
report statistics > "$module_name"_16.statistics.rpt
exit -f
